...
export default function DirectInChatAdaEnhancer() {
  ...
  return <>
    <button type="button" onClick={() => setOpen(value => !value)} aria-label="Open Ada for this chat" style={{ position: 'fixed', right: 20, bottom: 92, zIndex: 1200, border: '1px solid rgba(255,255,255,.14)', borderRadius: 999, background: '#101827', color: '#f7f2e8', padding: '10px 15px', boxShadow: '0 10px 30px rgba(0,0,0,.22)', cursor: 'pointer', fontWeight: 700, letterSpacing: '.01em' }}>Ada</button>
    {open && <section aria-label="Ada study panel" style={{ position: 'fixed', right: 20, bottom: 142, zIndex: 1200, width: 'min(380px, calc(100vw - 32px))', maxHeight: '72vh', overflowY: 'auto', border: '1px solid rgba(255,255,255,.12)', borderRadius: 18, background: '#0d1420', color: '#f7f2e8', padding: 16, boxShadow: '0 24px 60px rgba(0,0,0,.34)' }}>
