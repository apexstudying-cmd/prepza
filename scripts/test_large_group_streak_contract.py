"""Static contract checks for large groups and shared study streaks."""
...
assert "Only group admins can post in this broadcast group" in app
...
print("Large-group and shared-study-streak contract checks passed.")
